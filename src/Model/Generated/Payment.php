...
class Payment extends BunqModel
{
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponse<Payment>
     */
    public static function get(ApiContext $apiContext, $userId, $monetaryAccountId, $paymentId, array $customHeaders = [])
    {
        $apiClient = new ApiClient($apiContext);
     ...
     */
    public static function listing(ApiContext $apiContext, $userId, $monetaryAccountId, array $query = [], array $customHeaders = [])
    {
        $apiClient = new ApiClient($apiContext);
        $responseRaw = $apiClient->get(
            vsprintf(
